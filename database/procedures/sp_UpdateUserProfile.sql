...
CREATE OR REPLACE PROCEDURE sp_UpdateUserProfile(
    ...
    IN p_about_me TEXT,
    IN p_contact_email VARCHAR(145),
    ...
    IN p_street_name VARCHAR(20),
    IN p_street_numb VARCHAR(20),
    IN p_unit_numb VARCHAR(15),
    IN p_city VARCHAR(50),
    IN p_district VARCHAR(100),
    IN p_region VARCHAR(50),
    IN p_region_code VARCHAR(6), -- увеличим размер поля для формата "US-XX"
